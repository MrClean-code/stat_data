...
#                 continue
#
#         if 'plat' in filename.lower():  # если надо меняем на byt
#             # print(filename)
#             try:
#                 xls = pd.ExcelFile(filename)
#                 # i = 0
#                 for sheet_name in xls.sheet_names[1:2]:  # номер страницы
#                     # i += 1
...
#                             insert_data_document_in_db(filename, region, seal, date, 13)
#                             # print(filename,region,seal,date, 13)
#                 # break # только 1 файл
#             except Exception as e:
